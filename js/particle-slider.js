(function ParticleSlider(a) {
  ...
  if (a) {
    ...
    for (var d = 0, e = c.length; d & lt; e; d++) a[c[d]] & amp; & amp;
    (b[c[d]] = a[c[d]])
  }
  b.$container = b.$("#" + b.sliderId), b.$$children = b.$container.childNodes, b.$controlsContainer = b.$(".controls"), b.$$slides = b.$(".slide", b.$(".slides").childNodes, !0), b.$controlLeft = null, b.$controlRight = null, b.$canv = b.$(".draw"), b.$srcCanv = document.createElement("canvas"), b.$srcCanv.style.display = "none", b.$container.appendChild(b.$srcCanv), b.$prevCanv = document.createElement("canvas"), b.$prevCanv.style.display = "none", b.$container.appendChild(b.$prevCanv), b.$nextCanv = document.createElement("canvas"), b.$nextCanv.style.display = "none", b.$container.appendChild(b.$nextCanv), b.$overlay = document.createElement("p"), b.$container.appendChild(b.$overlay), b.imgControlPrev = null, b.imgControlNext = null, b.$$slides.length & lt; = 1 & amp; & amp;
  (b.showArrowControls = !1), b.$controlsContainer & amp; & amp;
  b.$controlsContainer.childNodes & amp; & amp;
  b.showArrowControls == !0 ? (b.$controlLeft = b.$(".left", b.$controlsContainer.childNodes), b.$controlRight = b.$(".right", b.$controlsContainer.childNodes), b.imgControlPrev = new Image, b.imgControlNext = new Image, b.imgControlPrev.onload = function() {
  ...
  }, b.imgControlPrev.src = b.$controlLeft.getAttribute("data-src"), b.imgControlNext.src = b.$controlRight.getAttribute("data-src")) : b.showArrowControls = !1, b.width & lt; = 0 & amp; & amp;
  (b.width = b.$container.clientWidth), b.height & lt; = 0 & amp; & amp;
  (b.height = b.$container.clientHeight), b.mouseDownRegion = 0, b.colorArr = b.parseColor(b.color), b.hoverColorArr = b.parseColor(b.hoverColor), b.mx = -1, b.my = -1, b.swipeOffset = 0, b.cw = b.getCw(), b.ch = b.getCh(), b.frame = 0, b.nextSlideTimer = !1, b.currImg = 0, b.lastImg = 0, b.imagesLoaded = 0, b.pxlBuffer = {
    first: null
  }, b.recycleBuffer = {
    first: null
    ...
    var a, b;
    for (var c = 0, d = this.length; c & lt; d; c++) b = Math.floor(Math.random() * d), a = this[c], this[c] = this[b], this[b] = a
    ...
    function c(a) {
      ...
      if (e) {
        ...
        while (e.offsetParent & amp; & amp; e != f) c += e.offsetParent.offsetLeft, d += e.offsetParent.offsetTop, e = e.offsetParent
      }
      this.x = c, this.y = d
    }
    ...
    if (b.imgs.length & gt; 1) {
      var a = 0;
      b.mx & gt; = 0 & amp; & amp;
      b.mx & lt;
      b.arrowPadding * 2 + b.$prevCanv.width ? a = -1 : b.mx & gt;
      0 & amp; & amp;
      b.mx & gt;
      b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) & amp; & amp;
      (a = 1), b.mouseDownRegion = a
    }
    ...
    if (b.imgs.length & gt; 1) {
      ...
      b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) & amp; & amp;
      (a = 1), a != 0 & amp; & amp;
      b.mouseDownRegion != 0 & amp; & amp;
      (a != b.mouseDownRegion & amp; & amp;
        (a *= -1), b.nextSlideTimer & amp; & amp; clearTimeout(b.nextSlideTimer), b.nextSlide(a)), b.mouseDownRegion = 0
    }
  };
  if (b.imgs.length == 0)
    for (var d = 0, e = b.$$slides.length; d & lt; e; d++) {
      var f = new Image;
...
psParticle.prototype.move = function() {
  var a = this.ps,
    b = this;
  if (this.ttl != null & amp; & amp; this.ttl-- & lt; = 0) a.swapList(b, a.pxlBuffer, a.recycleBuffer), this.ttl = null;
  else {
    var c = this.gravityX + a.swipeOffset - this.x,
      ...
      f = Math.atan2(d, c),
      g = e * .01;
    a.restless == !0 ? g += Math.random() * .1 - .05 : g & lt;
    .01 & amp; & amp;
    (this.x = this.gravityX + .25, this.y = this.gravityY + .25);
    var h = 0,
      i = 0;
    if (a.mx & gt; = 0 & amp; & amp; a.mouseForce) {
      var j = this.x - a.mx,
        k = this.y - a.my;
      h = Math.min(a.mouseForce / (Math.pow(j, 2) + Math.pow(k, 2)), a.mouseForce), i = Math.atan2(k, j), typeof this.color == "function" & amp; & amp;
      (i += Math.PI, h *= .001 + Math.random() * .1 - .05)
    } else h = 0, i = 0;
  ...
  var a = this;
  a.imagesLoaded++;
  if (a.imagesLoaded & gt; = 3 || a.showArrowControls == !1) a.resize(), a.slideDelay & gt;
  0 & amp; & amp;
  ...
  if (a[0] == ".") {
    ...
    b || (b = d.$$children);
    var f = [];
    for (var g = 0, h = b.length; g & lt; h; g++) b[g].className & amp; & amp;
    b[g].className == e & amp; & amp;
    f.push(b[g]);
    return f.length == 0 ? null : f.length == 1 & amp; & amp;
    !c ? f[0] : f
  }
  return document.getElementById(a.substr(1))
}, ParticleSlider.prototype.nextFrame = function() {
  var a = this;
  a.mouseDownRegion == 1 & amp; & amp;
  a.mx & lt;
  a.cw / 2 || a.mouseDownRegion == -1 & amp; & amp;
  a.mx & gt;
  a.cw / 2 ? a.swipeOffset = a.mx - a.cw / 2 : a.swipeOffset = 0;
  var b = a.pxlBuffer.first,
    c = null;
  while (b != null) c = b.next, b.move(), b = c;
  a.drawParticles();
  if (a.frame++ % 25 == 0 & amp; & amp;
    (a.cw != a.getCw() || a.ch != a.getCh())) {
    var d = a.getCh(),
      e = a.getCw();
    a.ch != e & amp; & amp;
    typeof a.onWidthChange == "function" & amp; & amp;
    a.onWidthChange(a, e), a.ch != d & amp; & amp;
    typeof a.onHeightChange == "function" & amp; & amp;
    a.onHeightChange(a, d), typeof a.onSizeChange == "function" & amp; & amp;
    a.onSizeChange(a, e, d), a.resize()
  }
  setTimeout(function() {
  ...
  var b = this;
  b.nextSlideTimer != null & amp; & amp;
  b.imgs.length & gt;
  1 ? (b.currImg = (b.currImg + b.imgs.length + (a ? a : 1)) % b.imgs.length, b.resize(), b.slideDelay & gt; 0 & amp; & amp;
    (b.nextSlideTimer = setTimeout(function() {
      b.nextSlide()
    }, 1e3 * b.slideDelay))) : b.slideDelay & gt;
  0 & amp; & amp;
  (b.nextSlideTimer = setTimeout(function() {
    b.nextSlide()
  }, 1e3 * b.slideDelay)), typeof b.onNextSlide == "function" & amp; & amp;
  b.onNextSlide(b.currImg)
  ...
  while (j != null) {
    e = ~~j.x, f = ~~j.y;
    for (g = e; g & lt; e + a.ptlSize & amp; & amp; g & gt; = 0 & amp; & amp; g & lt; a.cw; g++)
      for (h = f; h & lt; f + a.ptlSize & amp; & amp; h & gt; = 0 & amp; & amp; h & lt; a.ch; h++) d = (h * b.width + g) * 4, i = typeof j.color == "function" ? j.color() : j.color, c[d + 0] = i[0], c[d + 1] = i[1], c[d + 2] = i[2], c[d + 3] = i[3];
    j = j.next
  }
  ...
  var d = this,
    e = [];
  for (var f = 0; f & lt; a.width; f += d.ptlGap + 1)
    for (var g = 0; g & lt; a.height; g += d.ptlGap + 1) i = (g * a.width + f) * 4, a.data[i + 3] & gt;
  0 & amp; & amp;
  e.push({
    x: b + f,
    y: c + g,
  ...
  if (b.imgs.length & gt; 0) {
    ...
    if (b.showArrowControls == !0) {
      ...
      for (var e = 0, f = d.length; e & lt; f; e++) d[e].color = function() {
        return b.mx & gt; = 0 & amp; & amp;
        b.mx & lt;
        b.arrowPadding * 2 + b.$prevCanv.width ? b.hoverColorArr : b.colorArr
      }, c.push(d[e]);
      ...
      for (var e = 0, f = g.length; e & lt; f; e++) g[e].color = function() {
        return b.mx & gt;
        0 & amp; & amp;
        b.mx & gt;
        b.cw - (b.arrowPadding * 2 + b.$nextCanv.width) ? b.hoverColorArr : b.colorArr
      }, c.push(g[e])
    }
    if (b.currImg != b.lastImg || a == !0) c.shuffle(), b.lastImg = b.currImg;
    var h = b.pxlBuffer.first;
    for (var e = 0, f = c.length; e & lt; f; e++) {
      var i = null;
...
}, ParticleSlider.prototype.requestAnimationFrame =
function(a) {
  var b = this,
